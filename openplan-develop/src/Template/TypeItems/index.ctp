 ...
 * @var \App\Model\Entity\TypeItem[]|\Cake\Collection\CollectionInterface $typeItems
 */
?>
<div class="row">
    <div class="col-sm-3">
        <nav class="large-3 medium-4 columns" id="actions-sidebar">
            <ul class="list-group">
                ...
                <li class="list-group-item  waves-effect"><?= $this->Html->link(__('New Type Item'), ['action' => 'add']) ?></li>
    ...
    <div class="col-sm-9">
        <div class="typeItems index large-9 medium-8 columns content">
            <h3><?= __('Type Items') ?></h3>
            <table cellpadding="0" cellspacing="0" class="table">
                ...
                <tbody>
                    <?php foreach ($typeItems as $typeItem): ?>
                    <tr>
